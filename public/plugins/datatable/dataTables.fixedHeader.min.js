        ...
        m.extend(s.prototype, {
            ...
            _modeChange: function (t, e, o) {
                ...
                ("footer" === e && c) ||
                    ...
                    (s = m.contains(n[0], x.activeElement)
                        ? x.activeElement
                        : null),
                    ...
                    "in-place" === t
                        ? (h.placeholder &&
                          ...
                          m(m(h.host.parent()).parent()).scrollLeft(
                              d.scrollLeft()
                          ))
                        : "in" === t
                        ? (this._clone(e, o),
                ...
                this.s.dt.settings()[0].bDestroying ||
                    ...
                    this.c.header &&
                        ...
                        s + this.c.headerOffset + p.theadHeight <= b
                            ...
                            : (f = "below"),
                        (!t && f === this.s.headerMode) ||
                            this._modeChange(f, "header", t),
