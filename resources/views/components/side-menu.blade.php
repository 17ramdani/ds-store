<div class="uk-width-1-4@s">
    <ul id="pageSidebar" class="uk-nav-default uk-visible@s" uk-nav>
        ...
        @auth
            <li><!-- AFTER LOGIN!! -->
                <a href="https://drive.google.com/drive/folders/1iWGiZWTcRsQurmvQZyLKkBKLx6UB2xH2" target="_blank"><i
                        class="ph-light ph-book-open uk-margin-small-right"></i>E-Katalog</a>
            </li>
        @endauth
    </ul>
